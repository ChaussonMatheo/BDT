...
<div class="container">
    <!-- HEADER -->
    <div class="header">
        Confirmation de votre rendez-vous - BDT
    </div>
    ...
    <div class="content">
        ...
        <p>Votre rendez-vous a bien été enregistré dans notre application **BDT**.</p>
        ...
        <p>Vous pouvez accéder à votre espace client et gérer votre rendez-vous en cliquant sur le bouton ci-dessous :</p>
